...
function goodChoice1() {
  ...
  if (points < 1) {
    showPointsToUser = document.getElementById('final-points-0');
    showPointsToUser.innerHTML = points;
    document.getElementById('result').scrollIntoView();
  } else if (2 > points >= 1) {
    showPointsToUser = document.getElementById('final-points-1-2');
    showPointsToUser.innerHTML = points;
    document.getElementById('result').scrollIntoView();
  } else {
    showPointsToUser = document.getElementById('final-points-3');
    showPointsToUser.innerHTML = points;
    document.getElementById('result').scrollIntoView();
  }
}
